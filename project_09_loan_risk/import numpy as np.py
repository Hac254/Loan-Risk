...
class LoanRiskPredictor:
    ...
    def preprocess(self):
        ...
        if self.df['monthly_income'].isnull().sum() > 0:
            ...
            self.df['monthly_income'].fillna(median_income, inplace=True)
            print(f"[✓] Missing values in 'monthly_income' imputed with median (KSh {median_income:,.2f}).")
    ...
    def perform_feature_analysis(self):
        ...
        plt.close()
        print("[✓] Saved Visualisation 1: 'feature_correlation_heatmap.png'")
    ...
    def train(self, model_type='KNN'):
        ...
        if model_type == 'KNN':
            ...
            plt.close()
            print("[✓] Saved Visualisation 2: 'knn_tuning_curve.png'")
    ...
    def evaluate(self):
        ...
        plt.close()
        print("[✓] Saved Visualisation 3: 'model_accuracy_comparison.png'")
        ...
        plt.close()
        print("[✓] Saved Visualisation 4: 'confusion_matrices.png'")
